export const translations = {
  pt: {
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            'Feedback: a mensagem que envias (problema ou sugestão), sem pedido de contacto.',
    ...
    notifyPrefs: {
      ...
      sjoao: 'Palco S. João',
      sjoaoHint: '15 min antes das actuações neste palco.',
      ...
      needEnable: 'Activa primeiro as notificações neste telemóvel para guardares as preferências.',
    ...
    admin: {
      ...
      notifyConfirmHint:
        'Este aviso chega a quem activou as notificações. Confirma o conteúdo e a hora antes de continuar.',
      ...
      notifyConfirmAutoIntro: 'Vão ser criados ou actualizados alertas automáticos:',
      ...
      notifyConfirmModeReactivate: 'Reactivar envios',
      notifyConfirmDeactivateHint:
        'Nenhum destes dispositivos receberá avisos até reactivares. As preferências e os endpoints mantêm-se — não apaga as subscrições.',
      ...
      notifyDeactivateConfirm: 'Confirmar desactivação',
      ...
      analytics: {
        ...
        summaryHint: 'Números do período seleccionado. Comparação “hoje vs ontem” em hora de Lisboa.',
        todayLabel: 'Hoje',
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            'Feedback: the message you send (problem or suggestion), with no contact requested.',
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            'Avis / feedback : le message envoyé (problème ou suggestion), sans demande de contact.',
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            'Feedback: el mensaje que envías (problema o sugerencia), sin pedir contacto.',
